...
const translations = {
  en: {
    ...
    "sa.badge.none": "no tools",
    "sa.badge.readonly": "read-only",
    "sa.badge.full": "full access",
    "sa.budget.title": "Token budget — click to edit",
    "sa.iters.title": "Max iterations — click to edit",
    "sa.reasoning.title": "Reasoning effort",
    "sa.budget.saved": "{type} budget updated",
    "sa.budget.failed": "Failed to update {type} budget",
    "sa.reasoning.saved": "{type} reasoning updated",
    "sa.reasoning.failed": "Failed to update {type} reasoning",
    "subagent.partial.budget": "partial · budget exhausted",
    "subagent.partial.iterations": "partial · iteration limit reached",
    "swarm.degraded": "{n} partial",
  ...
  zh: {
    ...
    "sa.badge.none": "无工具",
    "sa.badge.readonly": "只读",
    "sa.badge.full": "全部工具",
    "sa.budget.title": "Token 预算 — 点击编辑",
    "sa.iters.title": "迭代上限 — 点击编辑",
    "sa.reasoning.title": "推理强度",
    "sa.budget.saved": "{type} 预算已更新",
    "sa.budget.failed": "{type} 预算更新失败",
    "sa.reasoning.saved": "{type} 推理强度已更新",
    "sa.reasoning.failed": "{type} 推理强度更新失败",
    "subagent.partial.budget": "部分完成 · 预算耗尽",
    "subagent.partial.iterations": "部分完成 · 已达迭代上限",
    "swarm.degraded": "{n} 部分完成",
